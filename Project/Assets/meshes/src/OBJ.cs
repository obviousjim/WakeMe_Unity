...
public class OBJ : MonoBehaviour {
	...
	private void SetGeometryData(string data) {
		...
		//Debug.Log ("UVS? " + (buffer.hasUVs ? "YES" : "NO") );
		// buffer.Trace();
	}
	...
	private void Build() {
		...
		//ms[0].GetComponent<MeshFilter>().sharedMesh.RecalculateNormals();
		//Debug.Log ("finished building meshes, sending message");
		//SendMessageUpwards("MeshesComplete", ms[0], SendMessageOptions.DontRequireReceiver);
	}
}
